...
for i in range(4):
    image_canvas.create_line(quad_vertices[i - 1][0], quad_vertices[i - 1][1], quad_vertices[i][0], quad_vertices[i][1],
                             fill='blue')
...
for i in range(4):
    mapped_canvas.create_line(rect_vertices[i - 1][0], rect_vertices[i - 1][1], rect_vertices[i][0],
                              rect_vertices[i][1], fill='blue')
